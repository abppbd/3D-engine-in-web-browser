...
function loadJSON(){
  let geom = 
  [{"Id": 0, "name": "test", "mode": "pe", "isRendered": false, "position": [0.0, 0.0, 0.0], "rotation": [0.0, 0.0],
